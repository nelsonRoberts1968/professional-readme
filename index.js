...
const questions = [
...

  {
    ...
    name: "confirmUsage",
    message:
      "Would you like to provide instructions on how to use your application?",
  },
  {
    //if confirmed
    type: "input",
...
async function init() {
  try {
    ...
    console.log(
      "Thank you! The current data is being processed into your README.md: ", userAnswers);
